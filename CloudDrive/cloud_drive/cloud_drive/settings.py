...
SECRET_KEY = "django-insecure-&4uf7@zb(d^qv=hs110)2e2@wk(z_-k3=mz90%h153c=aq35aj"
...
INSTALLED_APPS = [
    ...
    "drive",  # Votre application pour le Cloud Drive
    "django.contrib.sites",  # Nécessaire pour l'authentification
